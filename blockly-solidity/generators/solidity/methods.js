...
*/
  return [variableId + '(' + args + ')', Blockly.Solidity.ORDER_ATOMIC];
...
Blockly.Solidity['library_method_call'] = function(block) {
  ...
  if (typeof functionName == 'undefined' || libraryName == "select external contract or library..." || functionName == null)
    return '';
